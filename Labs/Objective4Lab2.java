...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    int whoAnswer = num1 + num2 + num3;
    Double decAnswer = dub1 + dub2 + dub3;

    System.out.println("The sum of " + num1 + " + " + num2 + " + " + num3 + " = " + whoAnswer);

    System.out.println("The sum of " + dub1 + " + " + dub2 + " + " + dub3 + " = " + decAnswer);
